   ...
   stages{
    ...
    stage('dockerImageTag'){
        steps{
            ...
            sh 'docker tag imagesversion 039612886015.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
        }
    }
    stage('pushImage'){
        steps{
        sh 'docker push 039612886015.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:latest'
        sh 'docker push 039612886015.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
        }
    }
   } 
